...
function orthographicCameraExport(cords: number[], ref: React.RefObject<THREE.OrthographicCamera> ){
...
export function SwitchBetweenCameras(orthographicSwitch: props) {
  const { isOrthographic, setIsOrthographic, cameraCoordinates, persCameraRef, orthoCameraRef } = orthographicSwitch;

  return (
    isOrthographic ? orthographicCameraExport(cameraCoordinates, orthoCameraRef) : perspectiveCameraExport(cameraCoordinates, persCameraRef)  
  );
}
