...
export const CustomPivotControls = React.forwardRef<
  THREE.Group,
  CustomPivotControlsProps
>(
  (
    {
      matrix,
      ...
      () => ({
        ...
        onDrag: (mdW: THREE.Matrix4) => {
          ...
          if (autoTransform) {
            ...
            gizmoRef.current.scale
              .copy(cameraScale.current)
              .divide(gizmoScale.current);
